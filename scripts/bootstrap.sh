...
#sudo curl -O https://archive.apache.org/dist/lucene/solr/4.10.0/solr-4.10.0.zip
#sudo unzip solr-4.10.0.zip
#sudo rm solr-4.10.0.zip
#cd solr-4.10.0/example/

sudo curl -O http://archive.apache.org/dist/lucene/solr/4.7.1/solr-4.7.1.zip
sudo unzip solr-4.7.1.zip
sudo rm solr-4.7.1.zip
cd solr-4.7.1/example/

# Solr startup
sudo java -jar start.jar > /tmp/solr-server-log.txt &
